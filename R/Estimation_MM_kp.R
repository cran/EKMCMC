#' Simulataneous estimation of Michaelis-Menten constant and catalytic constant
#'
#' The function estimates both catalytic and MM constant simultaneously with given
...
#' input constants of enzyme concentration, substrate concentration.
...
MM_catal_est <- function(method = T, time, species, enz, subs, MM, catal, tun = 2.4, std, nrepeat, jump = 1, burning = 0,
